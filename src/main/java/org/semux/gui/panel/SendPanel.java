...
public class SendPanel extends JPanel implements ActionListener {
    ...
    private static final long DEFAULT_GAS_CALL = 100_000;
    private static final long DEFAULT_GAS_CREATE = 2_000_000;
    ...
    public SendPanel(SemuxGui gui, JFrame frame) {
        ...
        rdbtnCreate = new JRadioButton(GuiMessages.get("Create"));
        rdbtnCall = new JRadioButton(GuiMessages.get("Call"));
        ...
        rdbtnCreate.addActionListener(e -> resetToDefault());
        rdbtnCall.addActionListener(e -> resetToDefault());
    ...
    protected void resetToDefault() {
        lblTo.setVisible(rdbtnCall.isSelected());
        selectTo.setVisible(rdbtnCall.isSelected());
        btnAddressBook.setVisible(rdbtnCall.isSelected());
        setTo(Bytes.EMPTY_BYTES);
        setValue(Amount.ZERO);
        setGas(rdbtnCall.isSelected() ? DEFAULT_GAS_CALL : DEFAULT_GAS_CREATE);
