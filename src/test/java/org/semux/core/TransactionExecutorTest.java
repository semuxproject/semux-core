...
public class TransactionExecutorTest {
    ...
    private TransactionResult executeAndCommit(TransactionExecutor exec, Transaction tx, AccountState as,
        ...
        TransactionResult res = exec.execute(tx, as, ds, bh, chain.isVMEnabled(), 0);
        as.commit();
        ds.commit();
    ...
    public void testTransfer() {
        ...
        TransactionResult result = exec.execute(tx, as.track(), ds.track(), block, chain.isVMEnabled(), 0);
        ...
        result = exec.execute(tx, as.track(), ds.track(), block, chain.isVMEnabled(), 0);
