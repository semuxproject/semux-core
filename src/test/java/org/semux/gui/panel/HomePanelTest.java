...
public class HomePanelTest {
    ...
    public void testProgressFormatter() {
        assertEquals("100.0 %", HomePanel.ProgressFormatter.format(new SemuxSync.SemuxSyncProgress(100L, 100L)));
        assertEquals("-", HomePanel.ProgressFormatter.format(new SemuxSync.SemuxSyncProgress(100L, 0L)));
        assertEquals("12.3 %", HomePanel.ProgressFormatter.format(new SemuxSync.SemuxSyncProgress(1234L, 10000L)));
        assertEquals("0.0 %", HomePanel.ProgressFormatter.format(new SemuxSync.SemuxSyncProgress(0L, 10000L)));
    }
}
