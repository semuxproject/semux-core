...
public class NativeTest {
    ...
    public void testVerifyBatch_small() {
        ...
        byte[][] msgs = IntStream.range(0, pks.length).mapToObj(i -> Hex.decode0x("0x010100000000000000c8000000002032da907fbec0da4c6c50c5b22690ebd81f0b494f6a88a0fd95626c0705391aef")).toArray(byte[][]::new);
        byte[][] sigs = Stream.of(
