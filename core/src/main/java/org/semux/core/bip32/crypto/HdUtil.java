...
public class HdUtil {
    ...
    /**
     * ser256(p): serializes the integer p as a 32-byte sequence, least significant
     * byte first.
     *
     * @param p
     *            big integer
    ...
    public static byte[] getFingerprint(byte[] keyData) {
        byte[] point = Secp256k1.serP(Secp256k1.point(org.semux.core.bip32.crypto.HdUtil.parse256(keyData)));
